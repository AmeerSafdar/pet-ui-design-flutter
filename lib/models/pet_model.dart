...
var owner = Owner(
    name: 'Roselia Drew',
    sub: "He/she is owner of Pet",
    imageUrl: 'assets/images/user.png',
    bio:
        """I recently lost my job and don\'t have enough time
         or money to tend to Darlene anymore. I have a lot of health 
         issues that need attention and want to give Darlene the best life possible.""");
var pets = [
  Pet(
    owner: owner,
